...
public class Sparbuch extends Konto {
	...
	public boolean abheben (double betrag) throws GesperrtException{
		double betragInKontowaehrung = this.waehrung.umrechnen(betrag); 
		if (betrag < 0 ) {
		...
		if (getKontostand() - betragInKontowaehrung >= 0.50 && 
				 bereitsAbgehoben / this.waehrung.getKurs() + betragInKontowaehrung <= Sparbuch.ABHEBESUMME / this.waehrung.getKurs())
		{
			setKontostand(getKontostand() - betragInKontowaehrung);
